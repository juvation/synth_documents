	...
	<html>
	<head>
		<title>SoundBank: Red Sound C-Loops</title>
	...
	<tr>
		...
		<tr>
			<td style="padding-left: 5px; padding-top: 6px" class="navtext"><div id="PageTitle">SoundBank: Red Sound C-Loops</div>
			</td>
...
<span class="soundbankicon"><a href="/sos/jan02/audio/cloopsdemo.mp3"><img src="/images/sspeaker.gif" align="absmiddle" border="0"></a></span>C&ndash;Loops Demo</div>
</div>
</td>
</tr>
</table>
<p><span class="MainTitle"><a href="/sos/jan02/articles/redsound.asp" target="mainframe">Red Sound C&ndash;Loops</a></span><br/>
	<span class="SubTitle">Loop Sampler</span></p>
<p><img src="../images/soundbank/cloop.jpg" width="102" height="200" alt="Red Sound C&ndash;Loops" border="0"></p>
<p class="introtext">The unique new C&ndash;Loops from Red Sound Systems can automatically detect the tempo of incoming audio, sample it and chop it to length ready for re&ndash;triggering, as well as automatically timestretching all its on&ndash;board loops to match any new tempo it receives.</p>
