	...
	<html>
	<head>
		<title>SoundBank: Yamaha Motif ES</title>
	...
	<tr>
		...
		<tr>
			<td style="padding-left: 5px; padding-top: 6px" class="navtext"><div id="PageTitle">SoundBank: Yamaha Motif ES</div>
			</td>
...
<p class="mediumblacktext">SoundBank is our central audio download area. Here we amass the example audio files that accompany some of the monthly <i>Sound&nbsp;On&nbsp;Sound</i> product tests. Most audio examples come in MP3 file format and might need to be saved to your computer's hard disk before they can be auditioned (using your browser or an MP3 player of your choice).</p><p><img src="../images/soundbank/YamahaMotif.jpg" width="350" height="212" alt="Yamaha Motif ES" border="0"></p>
<table border="0" cellspacing="8" cellpadding="0" align="right">
<tr>
<td>
<div class="soundbankbox">
<div class="soundbanktext">
<span class="soundbankicon"><a href="/sos/jan04/audio/motif/1VoicePre1B15HardVintage.mp3"><img src="/images/sspeaker.gif" align="absmiddle" border="0"></a></span>Voice Preset 1 B15 Hard Vintage<br/>
It's hard not to put forward an electric piano preset as an example of what a Yamaha synth does well. This voice has had its arpeggiator enabled, which is set to a simple but appropriate pattern. This short example also illustrates the automatic chord recognition of the arpeggiator as the held chord moves from open 5th, to major, to minor, to minor 7th and finally to major 7th.</div>
<div class="soundbanktext">
<span class="soundbankicon"><a href="/sos/jan04/audio/motif/2VoicePre2C01Mega12Str.mp3"><img src="/images/sspeaker.gif" align="absmiddle" border="0"></a></span>Voice Preset 2 C01 Mega 12Str<br/>
Another effective acoustic simulation. The arpeggiator pattern here illustrates the &#0145;Mega Voice' concept, with performance&ndash;related mutes adding to the illusion.</div>
<div class="soundbanktext">
<span class="soundbankicon"><a href="/sos/jan04/audio/motif/3DrumPDR D11ArabicMix.mp3"><img src="/images/sspeaker.gif" align="absmiddle" border="0"></a></span>Drum Kit Preset Drums D11 Arabic Mix<br/>
The example for this exciting kit not only shows off the drum&ndash;specific arpeggiator patterns but also the easy way in which arp patterns can be changed mid&ndash;performance &mdash; five patterns can be assigned to a Voice or Performance and instantly selected via soft keys under the Motif ES's display.</div>
<div class="soundbanktext">
<span class="soundbankicon"><a href="/sos/jan04/audio/motif/4PerfUserA01CyberStep.mp3"><img src="/images/sspeaker.gif" align="absmiddle" border="0"></a></span>Performance User A01 Cyber Step<br/>
This Performance illustrates the effect of the arpeggiator with its &#0145;Hold' parameter set to &#0145;off': every time you play a key, the arp pattern starts from the beginning. The alternative, with Hold set to &#0145;on', cause the pattern to play continuously even if you don't hold a key or keys down. Note that what sounds like two arpeggiators playing in this example is caused by the custom waveform of one of the Performance Voice's MIDI&ndash;sync'd LFOs modifying pitch in an arpeggiator&ndash;like manner.</div>
<div class="soundbanktext">
<span class="soundbankicon"><a href="/sos/jan04/audio/motif/5PerfUserG08LunarBeats.mp3"><img src="/images/sspeaker.gif" align="absmiddle" border="0"></a></span>Performance User G08 Lunar Beats<br/>
Just another good, atmospheric Performance. Most &#0145;one&ndash;finger instant tracks' such as this suffer from the single arpeggiator, though. Here, as with many Performances its tied to a drum kit, with planning and careful programming required to fill the rest of the &#0145;track' out.</div>
<div class="soundbanktext">
<span class="soundbankicon"><a href="/sos/jan04/audio/motif/6PerfUserG16TranceSet.mp3"><img src="/images/sspeaker.gif" align="absmiddle" border="0"></a></span>Performance User G16 TranceSet<br/>
Not so much a one&ndash;finger track, since three fingers were used to access the three&ndash;way split of bass, floaty sound, and plucky hit.</div>
</div>
</td>
</tr>
</table>
<p><span class="MainTitle"><a href="/sos/jan04/articles/yamahamotifes.htm" target="_blank">Yamaha Motif ES</a></span><br/>
<span class="SubTitle">Music Production Synthesizer</span></p>
<p class="introtext">Two and a half years after the launch of Yamaha's impressive Motif workstation synth, the range has been further enhanced and upgraded. How much better can it get? We find out...</p>
<p class="smallblacktext">Reviewed January 2004</p>
