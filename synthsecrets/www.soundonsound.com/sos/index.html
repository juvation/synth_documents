...
<tr>
	...
	<td align="left" valign="middle"><a href="javascript:GoSearch()"><img src="/images/nav_go.gif" border="0" alt="Go" name="Search" /></a></td>
		...
		<tr>
		<td valign="top" width="156" style="padding-right: 10px; border-right: solid 1px #cccccc"><div class="smallblacktext"><br /></div></td><td style="padding-left: 20px; padding-right: 20px; padding-top:10px" valign="top"><p>&nbsp;</p><center><div style="padding: 10px"><div style="width: 300px; padding: 5px; border: 1px solid crimson">
<p class="warningtext">SORRY: Not Available</p>
<p><b>The article or function you have requested is <i>not</i> available on this site</b>.</p>
<p>The majority of SOS articles from January 1994 to the current issue are published on this site. However, due to copyright restrictions, a small number of past articles have not been posted to our site. If you feel there is an error on a file, please email <a href="mailto:webmaster@soundonsound.com">webmaster@soundonsound.com</a> and paste the URL of the missing article into the email.</p>
<p class="Small">We include a full database of ALL articles back to Issue 1 (November 1985) as a special service to longterm paper readers who wish to use our <a href="/search">search engine</a> to quickly locate material within their magazines.</p>
<p class="Small">We have no plans to add pre-1994 articles to this site.</p>
<p class="Row" align="center"><a href="javascript:history.back()">Go Back</a><br/></p></div></div></center><p>&nbsp;</p></td><td valign="top" height="200" width="135" style="padding-left: 10px; border-left: solid 1px #cccccc"><span class="Small">Monday 20th February 2006</span><br /><br />
