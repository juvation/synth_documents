	...
	<html>
	<head>
		<title>Articles: People >> Engineer, Producer, Musician, SOS Reader interviews and more!</title>
	...
	<tr>
		...
		<tr>
			<td style="padding-left: 5px; padding-top: 6px" class="navtext"><div id="PageTitle">Articles: People >> Engineer, Producer, Musician, SOS Reader interviews and more!</div>
			</td>
...
<tr>
	...
	<td align="left" valign="middle"><a href="javascript:GoSearch()"><img src="/images/nav_go.gif" border="0" alt="Go" name="Search" /></a></td>
		...
		<tr>
		<td valign="top" width="156" style="padding-right: 10px; border-right: solid 1px #cccccc"><div class="smallblacktext"><div class="LeftLink"><img src="/images/linkbullet.gif" height="7" width="7" border="0">&nbsp;<a href="/articles/Reviews.php">Product Reviews</a><br/><img src="/images/linkbullet.gif" height="7" width="7" border="0">&nbsp;<a href="/articles/Technique.php">Technique</a><br/><img src="/images/linkbullet.gif" height="7" width="7" border="0">&nbsp;<a href="/articles/SoundAdvice.php">Sound Advice</a><br/><img src="/images/linkbullet.gif" height="7" width="7" border="0">&nbsp;<a href="/articles/People.php">People</a><br/></div><br /><div style="width: 145px; border: solid 1px gray; padding: 3px">
...
</div><br /><br /></div></td><td style="padding-left: 20px; padding-right: 20px; padding-top:10px" valign="top"><div class="PageHeader">People &amp; Music Business</div><p>Since its inception in 1985, SOUND ON SOUND magazine has always included insightful interviews with the artists and technicians involved in the recording process of many top albums. We don't ask them the colour of their underwear or who they're dating &mdash; SOS concentrates on tech talk. And we regularly feature interviews with our very own readers, to discover how the gear we test is being creatively used and abused in the real world.</p><ul><li><a href="/search?url=%2Fsearch&Section=6&Subject=20&Summary=Yes"><b>Artists/Engineers/Producers/Programmers</b></a>&nbsp;&nbsp;Includes all artist interviews, whether conducted with the Engineer or Producer about the making of the artist's album/project or with the artists/band themselves.</li>
	<li><a href="/search?url=%2Fsearch&Section=6&Subject=32&Summary=Yes"><b>Industry/Music Biz</b></a>&nbsp;&nbsp;Includes interviews with manufacturers' technical staff, equipment designers and company personnel, manufacturer profiles, and certain studio visits (except 'Readerzone').</li><li><a href="/search?url=%2Fsearch&Section=6&Subject=65&Summary=Yes"><b>Readerzone</b></a>&nbsp;&nbsp;Interviews with <i>SOS</i> readers about their own home/project studio.</li>
	<li><a href="/search?url=%2Fsearch&Section=6&Subject=79&Summary=Yes"><b>Studio SOS</b></a>&nbsp;&nbsp;Not content with offering written advice, this popular feature sees the <i>SOS</i> technical crew get out and about visiting <i>SOS</i> readers in their own homes/project studios, where Paul White, Hugh Robjohns and other contributors set about solving the reader's real-world production, miking and monitoring problems.</li>
	<li><a href="/search?url=%2Fsearch&Section=6&Subject=80&Summary=No"><b>Sounding Off</b></a>&nbsp;&nbsp;Our monthly opinion column where <i>SOS</i> readers have their say.</li><li><a href="/search?url=%2Fsearch&Section=9&Summary=Yes"><b>Music Business</b></a>&nbsp;&nbsp;this section covers articles about the workings of the music business (eg. Big George's 'Doing The Business' columns and Tom Flint's 'Running Your Own Record Label' series.</li></ul>
<p>&nbsp;</p>
