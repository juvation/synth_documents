	...
	<html>
	<head>
		<title>How to contact SOS staff</title>
	...
	<tr>
		...
		<tr>
			<td style="padding-left: 5px; padding-top: 6px" class="navtext"><div id="PageTitle">How to contact SOS staff</div>
			</td>
...
<div class="PageHeader">Contact SOS</div>
<p class="mediumblacktext"><img src="../images/sosfcs.jpg" alt="" height="44" width="300" border="0"><br/> Media House, Trafalgar Way, Bar Hill,<br/> Cambridge, CB3 8SQ, United Kingdom</p>
<p class="mediumgreytext"><span class="mediumblacktext">Tel:</span>+44 (0)1954 789888 <span class="mediumblacktext"> Fax:</span> +44 (0)1954 789895<br/> 
<span class="mediumblacktext">ISDN:</span> +44 (0)1954 781023</p>
<p class="mediumgreytext"><span class="mediumblacktext">Email:</span> <a href="mailto:sos@soundonsound.com">sos@soundonsound.com</a><br/> <span class="mediumblacktext">Web site:</span> <a href="http://www.soundonsound.com" target="_top">www.soundonsound.com</a></p>

	<p class="smallgreytext">
	GENERAL ENQUIRIES: <a href="mailto:sos@soundonsound.com">sos@soundonsound.com</a><br/>
	EDITORIAL: <a href="mailto:feedback@soundonsound.com">feedback@soundonsound.com</a><br/>
	Please post editorial queries, advice, hints/tips in the <a href="http://www.soundonsound.com/forum" target="_top">SOS Discussion Forum</a><br/>
	DISPLAY ADVERTISING (UK edition): <a href="mailto:adsales@soundonsound.com">adsales@soundonsound.com</a><br/>
	CLASSIFIED ADVERTISING: <a href="mailto:classifieds@soundonsound.com">classifieds@soundonsound.com</a><br/>
	SUBSCRIPTIONS: <a href="mailto:sos.subs@soundonsound.com">subscribe@soundonsound.com</a><br/>
	MAIL ORDER: <a href="mailto:mailorder@soundonsound.com">mailorder@soundonsound.com</a>
	</p>

<form action='http://www.soundonsound.com/information/xt_ContactSOS.php' method="post">
<span class="smallblacktext">To contact <b>Sound On Sound</b> staff, please select below:<br/></span>
	<select name="EmailTo" style="width: 300px" size="1">
		<option value=" ">EDITORIAL</option>
		<option value="1">&nbsp;&nbsp;Paul White - Editor In Chief</option>
		<option value="2">&nbsp;&nbsp;Hugh Robjohns - Technical Editor</option>
		<option value="3">&nbsp;&nbsp;Matt Bell - Managing Editor</option>
		<option value="4">&nbsp;&nbsp;Sam Inglis - Features Editor</option>
		<option value="5">&nbsp;&nbsp;Mike Senior - Reviews Editor</option>
		<option value="6">&nbsp;&nbsp;Debbie Poyser - Columns Editor</option>
		<option value="7">&nbsp;&nbsp;David Greeves - News Editor</option>
		<option value="8">&nbsp;&nbsp;David Glasper - Editorial Assistant</option>
		<option value="9">&nbsp;&nbsp;Dave Lockwood - Publisher</option>
		<option value=" ">ADVERTISING</option>
		<option value="10">&nbsp;&nbsp;Robert Cottee - Group Sales Manager</option>
		<option value="11">&nbsp;&nbsp;Patrick Shelley - Classified Sales Manager</option>
		<option value="12">&nbsp;&nbsp;Steve Sattler - US Sales Manager</option>
		<option value=" ">PRODUCTION</option>
		<option value="13">&nbsp;&nbsp;Andy Brookes - Production &amp; Event Manager</option>
		<option value="14">&nbsp;&nbsp;Andy Baldwin - Designer &amp; Digital Media</option>
		<option value="15">&nbsp;&nbsp;Alan Edwards - Designer</option>
		<option value="16">&nbsp;&nbsp;Michael Groves - Classified Production</option>
		<option value=" ">SUBSCRIPTIONS</option>
		<option value="17">&nbsp;&nbsp;Luci Smith - Circulation Administrator</option>
		<option value=" ">MAIL ORDER</option>
		<option value="18">&nbsp;&nbsp;Lisa Carminati - Mail Order Administrator</option>
		<option value=" ">ADMINISTRATION &amp; MANAGEMENT</option>
		<option value="19">&nbsp;&nbsp;Ian Gilby - Managing Director/President</option>
		<option value="20">&nbsp;&nbsp;Keith Werthmann - Accounts Manager</option>
	</select>
	<p>Your email:<br/> <input type="text" name="EmailFrom" size="50" /></p>
	<p>Subject:<br/>
		<input type="text" name="Subject" style="width: 300px" size="50" /></p>
	<p>Message:<br/>
		<textarea name="Comment" style="width: 300px; font-family: arial, helvetica" rows="7" cols="55"></textarea></p>
