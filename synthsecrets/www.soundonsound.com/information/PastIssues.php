	...
	<html>
	<head>
		<title>Past Issue contents lists</title>
	...
	<tr>
		...
		<tr>
			<td style="padding-left: 5px; padding-top: 6px" class="navtext"><div id="PageTitle">Past Issue contents lists</div>
			</td>
...
<div class="PageHeader">Past Issue contents lists</div>
<p><b>How do I generate Past Issue contents lists for specific months/years I am looking for?</b>
</p>
<p>You could click the SEARCH button above and then make your selection(s) using just the MONTH and YEAR menus in the lefthand search box. This generates a results list of articles in your chosen issue. Just click the links to open articles.</p>
<p>Alternatively, you can bookmark/add to favourites the following web page, which always lists the very latest issue on our site and auto-updates whenever a new issue is posted to the site.</p>
<p><a href="/Contents.php">http://www.soundonsound.com/Contents.php</a><br/>Current Issue contents list</p>
<p>You can call up specific issues by editing the relevant parts of this variation of the URL, as shown below:</p>
<p><a href="/Contents.php?Month=1&Year=2003">http://www.soundonsound.com/Contents.php?Month=1&amp;Year=2003</a><br/>
January 2003 contents list</p>
<p>
<a href="/Contents.php?Month=12&Year=1998">http://www.soundonsound.com/Contents.php?Month=12&amp;Year=1998</a><br/>
December 1998 contents list</p>
<p>&nbsp;</p>
...
<img src="/images/linkbullet.gif" height="7" width="7" hspace="2"><div style="position: relative; top: -10px; left: 12px"><div class="RightLink" style="padding-bottom: 10px"><a href="javascript:SwitchNav('0')">Show old-style menus</a></div></div><div class="smallblacktext"><img src="/images/linkbullet.gif" height="7" width="7" hspace="2"><div style="position: relative; top: -10px; left: 12px"><a class="RightLink" href="http://www.soundonsound.com/search?url=%2Fsearch&Keyword=&Words=All&Section=+&Subject=+&Month=+&Year=+&Summary=Yes&CB=1&Articles=Search+Articles">List of all SOS articles (PDF) available to buy from BT Click&Buy</a></div><br /></div></td></tr></table><br/><table cellpadding="0" cellspacing="0" border="0" width="100%">
<tr>
