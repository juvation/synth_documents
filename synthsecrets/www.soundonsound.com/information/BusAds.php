	...
	<html>
	<head>
		<title>Trade or Private seller?</title>
	...
	<tr>
		...
		<tr>
			<td style="padding-left: 5px; padding-top: 6px" class="navtext"><div id="PageTitle">Trade or Private seller?</div>
			</td>
...
<div class="PageHeader">Trade or Private?</div>
<p><b>Business Advertisement Disclosure Order 1977</b><br/>
<p>This is a guide to the requirements of The Business Advertisements Disclosure Order 1977. This law exists since consumers get better rights when they purchase goods from Traders rather than from Private sellers. It may therefore be in the interests of a dishonest Trader to pretend that he or she is selling privately in order to avoid the costs or risks of openly selling as a business.</p>
<p style="font-color: crimson; margin:10px">The Business Advertisement Disclosure Order 1977 requires all advertisements by people who seek to sell goods in the course of business to make the fact clear. This requirement applies whether the advertiser is acting on his own behalf or for some other person in the course of whose business goods are to be sold. <i>Consumers should be able to tell whether an advertisement relates to a sale by a Trader or a Private seller.</i> It is the responsibility of the Advertiser to comply with the order. It is an offence for which you may be prosecuted not to advertise the fact that you are a  Trader.</p>
<p>Everyone who registers with the SOS Readers Ads service is required to state in their My  Account record whether they are a Trader or Private seller. Trade ads will then be flagged with this  symbol: <span class="adTrade">Trader</span>. If you are unsure of your status, please read the guide  below.</p>
<p><b>What is a Business Advertisement?</b><br/>Any advertisement which offers goods for sale in the course of a business.</p>
<p><b>Do these requirements apply to me?</b><br/>Yes, if you publish or arrange an advert either for your own business, on behalf of someone else, or as  someone's agent.</p>
<p><b>Does this only apply to Newspaper adverts?</b><br/> No. It applies to <i>any</i> form of advertising: newspapers, magazines, TV or radio, periodicals,  leaflets, brochures, cards on notice boards in newsagents and supermarkets, the Internet, or on the  item itself.</p>
<p><b>What must the adverts say?</b><br/>It must clearly indicate that the goods are being sold in the course of a business.</p>
<p><b>What form must this indication take?</b><br/>It may be direct or by implication, so that the average person is aware it is a Trade sale. This could be  done, for example, by any of the following means: <ul>
 <li>Including a clear business name in the advert eg. &quot;Smiths Car Sales&quot;</li>
 <li>Giving a clear indication that it is a business sale, eg. [Trade]</li>
 <li>Giving an indication by means of the format or size of the advert or the place or manner  of its publication, such as: Yellow Pages; A business advert section of a newspaper; In the shop selling  the goods; in a Trade section of a web site.</li></ul></p>
 
 <p><b>Are all such adverts caught by the 1977 Order?</b><br/>
 The following adverts are <i>exempt</i> from the requirements: <ul>
 <li>Sale by auction or tender.</li>
 <li>Sale of flowers, fruit, vegetables, eggs, dead animals, fish or birds, gathered, produced or taken  by the seller.</li></ul></p>
 <p><b>It is the Advertiser's responsibility to ensure that the requirements of this Order are complied  with. Failure to do so could lead to prosecution by Trading Standards.</b></p>
